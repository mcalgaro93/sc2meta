...
This takes a long time. For songbird method we run on a server "songbird_data_preparation.R" to prepare single dataset for songbird pipelines, "consistency_replicability_songbird.bash" to run songbird and "consistency_replicability_aggregation.R" to collect all the outputs and create a single .RData file for 16S and WMS data.
