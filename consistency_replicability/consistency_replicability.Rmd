...
# svg("../../fig4.svg",width = 17, height = 11)
# fig
# dev.off()
```
...
# svg("../../fig4_mid_low.svg",width = 17, height = 22)
# fig
# dev.off()
```
...
a5 <- g_AUC50(conc_df = conc_df,div = "high",tech = "16S")
b5 <- g_AUC50(conc_df = conc_df,div = "high",tech = "WMS")
c5 <- g_AUC50(conc_df = conc_df,div = "mid",tech = "16S")
d5 <- g_AUC50(conc_df = conc_df,div = "mid",tech = "WMS")
e5 <- g_AUC50(conc_df = conc_df,div = "low",tech = "16S")
f5 <- g_AUC50(conc_df = conc_df,div = "mid",tech = "WMS")
