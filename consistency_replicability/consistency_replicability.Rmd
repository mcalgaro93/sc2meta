...
For some of the generated subsets, corncob DA detection methods will fail. It is suggested to generate more than 100 subsets and replace the failed outputs. (I did it manually directly on the server).

## Differential abundance testing

### WMS

"consistency_replicability_WMS_comparison_script.R", "consistency_replicability_WMS_comparison.bash" files, "consistency_replicability_16S_comparison_script.R", "consistency_replicability_16S_comparison.bash", were used to perform DA analysis using job-arrays. 
...
concordance_df_summary <- suppressWarnings(ddply(conc_df, ~ tech + comp + rank + method1 + method2, function(x) colMeans(x[,c("concordance","nfeatures")])))
